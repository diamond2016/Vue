...
wrapper = mount(Counter as any, {
  ...
  it('renders with default props (initialCount: 0, label: "Counter")', () => {
    ...
    expect((wrapper.find('h2') as any).text()).toBe('Counter 0');
  });
  ...
  it('renders with custom initialCount prop', () => {
    ...
    wrapper = mount(Counter as any, {
      props: {
        modelValue: 10, // Start count at 10 instead of 0
        label: 'Counter',
      },
    });

    // The count should start at the custom initialCount value
    expect((wrapper.find('h2') as any).text()).toBe('Counter 10');
  });
  ...
  it('renders with custom label prop', () => {
    ...
    expect((wrapper.find('h2') as any).text()).toBe('My Counter 5');
  });
  ...
  it('increments count when increment button is clicked', async () => {
    ...
    expect((wrapper.find('h2') as any).text()).toBe('Counter 1');
  });
  ...
  it('decrements count when decrement button is clicked', async () => {
    ...
    expect((wrapper.find('h2') as any).text()).toBe('Counter 4');
  });
  ...
  it('resets count to initialCount when reset button is clicked', async () => {
    ...
    await wrapper.find('#Reset').exists(true);
  ...
  it('always resets to initialCount regardless of current value', async () => {
    ...
    expect((wrapper.find('h2') as any).text()).toBe('Counter 5');
